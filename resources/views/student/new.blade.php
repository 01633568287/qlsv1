...
<form action="{{route('student.store')}}" method="POST" enctype="multipart/form-data">
	...
	<div class="form-group row">
		...
		<input type="text" name="fullname" id="fullname" class="form-control col-sm-10">
	</div>
	<div class="form-group row">
		<label class="col-sm-2 col-form-label" for="name">Ngày</label>
		<input type="date" name="DOB" id="DOB" class="form-control col-sm-10">
	</div>
	<div class="form-group row">
		<label class="col-sm-2 col-form-label" for="name">Giới tính</label>
		<input type="radio" name="sex" id="sex" class="form-control col-sm-10" value="1">
		<input type="radio" name="sex" id="sex" class="form-control col-sm-10" value="0">
	</div>
	<div class="form-group row">
	...
	<div class="form-group row">
		...
		<input type="number" name="class_id" id="class_id" class="form-control col-sm-10">
	</div>
	<div class="form-group row">
